...
HD_PWD='C:/Users/yufan lu/OneDrive/Vivado Projects/CPU_START_FROM_0/CPU_START_FROM_0.runs/ProgramMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgramMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProgramMemory.tcl
