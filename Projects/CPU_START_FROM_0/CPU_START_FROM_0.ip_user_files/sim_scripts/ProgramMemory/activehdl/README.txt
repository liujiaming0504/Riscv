...
#
# Generated by export_simulation on Thu Apr 30 22:49:23 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './ProgramMemory.sh' script.

./ProgramMemory.sh -reset_run
...
./ProgramMemory.sh -noclean_files

For more information on the script, please type './ProgramMemory.sh -help'.
